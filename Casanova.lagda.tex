...
\AgdaField{CAS.limit} \AgdaBound{v} \AgdaBound{x} \AgdaBound{c} \AgdaBound{e} is \AgdaBound{v}'s representation of \(\lim_{\AgdaBound{c} \rightarrow \AgdaBound{x}} \textrm{\Epsilon}\), where ``\(\textrm{\Epsilon}\)'' denotes the expanded version of the \AgdaBound{e} expression.
