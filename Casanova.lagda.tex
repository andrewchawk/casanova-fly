...
\AgdaFunction{uglyPrint} is the printing function which does not explicitly do currying and, accordingly, outputs stuff which strikes the author as being pretty randid.  Some people, however, prefer the ``\(f\left(x\right)\)'' notation over the ``\(f\ x\)'' notation.  The author does not understand these people but aims to at least occasionally please.
