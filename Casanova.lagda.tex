...
\AgdaField{CAS.derivativeRepresentation} \AgdaBound{c} \AgdaBound{names} \AgdaBound{uniqueness} \AgdaBound{e} represents the derivative of \AgdaBound{e} with respect to the variables whose names are listed in \AgdaBound{names}.
...
record CAS {a : Level} (ε : Set a) : Set (Level.suc Level.zero Level.⊔ a) where
  field
    ...
    derivativeRepresentation :
      (vars : List.List String) -> UniqueList vars -> ε -> ε
