...
record CAS {a : Level} (ε : Set a) : Set a where
  field
    ...
    differently-named-variables-are-not-definitely-equal :
      (name1 name2 : String) ->
      name1 ≢ name2 ->
      inj₂ false ≡ definitelyEquals (variableNamed name1) (variableNamed name2)
    identically-named-variables-are-equal :
      (name1 name2 : String) ->
      name1 ≡ name2 ->
      inj₂ true ≡ definitelyEquals (variableNamed name1) (variableNamed name2)
...
record VCAS {a : Level} (ε : Set a) (Cas : CAS ε) : Set a where
  ...
  field
    ...
    product-of-e-and-1-is-e :
      ...
      inj₂ true ≡ definitelyEquals (productRepresentation e (fromℕ 1)) e
\end{code}
...
CasanovaFly-Base = record
  ...
  ; identically-named-variables-are-equal =
    \ x y equality ->
    structural-equality-implies-definite-equality _ _ (cong Variable equality)
  ; differently-named-variables-are-not-definitely-equal = {!!}
  }
  where
  structural-equality-implies-definite-equality =
