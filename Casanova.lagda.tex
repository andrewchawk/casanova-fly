...
\begin{itemize}
 ...
 \item a proof of the equality between \(\limit_{x \rightarrow y} \left(a + b\right)\) and \(\left(\lim_{x \rightarrow y} a\right) + \lim_{x \rightarrow y} b\),
 \item a proof of the equality between \(\limit_{x \rightarrow y} \left(- x\right)\) and \(- \lim_{x \rightarrow y} x\),
 \item a proof of the equality between \(\limit_{x \rightarrow y} \left(a \cdot b\right)\) and \(\left(\lim_{x \rightarrow y} a\right) \cdot \lim_{x \rightarrow y} b\),
