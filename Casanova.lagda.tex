...
For all relevant \(v\), \(M\), and \(e\), if \(v\) is not referenced in \(M\), then \(\left(\lambda\ v \rightarrow M\right)\ e = M\).  The preceding fact is encoded through \AgdaField{VCAS.unapplicable-lambda-is-identity-function}.
...
structuralEqualityOnε = s
  ...
  s Infinity (Variable v) = no \ ()
  s Infinity (NumberRat r) = no \ ()
  s Infinity (Ap f x) = no \ ()
  s (Variable v) Infinity = no \ ()
  ...
  s (Variable v) (NumberRat r) = no \ ()
  s (Variable v) (Ap f x) = no \ ()
  s (NumberRat r) Infinity = no \ ()
  s (NumberRat r) (Variable v) = no \ ()
  ...
  s (NumberRat r) (Ap f x) = no \ ()
  s (Ap f x) Infinity = no \ ()
  s (Ap f x) (Variable v) = no \ ()
  s (Ap f x) (NumberRat r) = no \ ()
