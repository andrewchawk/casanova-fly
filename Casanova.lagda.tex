...
record VCAS {a : Level} (ε : Set a) (Cas : CAS ε) : Set a where
  ...
  field
    ...
    identically-named-variables-are-equal :
      ...
      name1 ≡ name2 ->
      (iterations : ℕ) ->
      Σ (_≈_ iterations (variableNamed name1) (variableNamed name2))
        (\ equality -> inj₂ (just equality) ≡ definitelyEquals iterations (variableNamed name1) (variableNamed name2))
    ...
    product-of-e-and-1-is-e :
      ...
      Σ (_≈_ iterations (productRepresentation e (fromℕ 1)) e)
        (\ equality -> inj₂ (just equality) ≡ definitelyEquals iterations (productRepresentation e (fromℕ 1)) e)
\end{code}
